...
if($query)
{
 echo "<script>alert('Gift has been added in to the cart');</script>";   
} else {
...
<head>
        <title>SSK Surprise Delivery || Gift Detail</title>
        	...
        	<div class="container">
        		<div class="banner_text">
        			...
        			<ul>
        				...
        				<li><a href="cake-detail.php">Gift Detail</a></li>
        			</ul>
        		</div>
        	</div>
        </section>
        ...
        <section class="special_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Detail of Gift</h2>
        			<h5>Give more, love more.</h5>
        		</div>
...
?>
							...
							<div class="col-lg-8">
								<div class="special_item_text">
									...
									<p><strong>Gift Type: </strong><?php echo $row['CategoryName'];?></p>
									
									<p><strong>Price: </strong> RM<?php echo $row['ItemPrice'];?></p>
									<p><strong>Theme: </strong> <?php echo $row['Weight'];?></p>
									<p><strong>Gift Detail: </strong> <?php echo $row['ItemDes'];?></p>
									<p><strong> </strong>

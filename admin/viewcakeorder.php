...
<head>
    ...
    <title>SSK Surprise Delivery System</title>
...
<td colspan="2" style="font-size:20px;color:blue">
 User Details</td></tr>
  ...
  <tr>
   ...
   <tr>
    <th>Special Instructions(Customization)</th>
    <td><?php  echo $row['giftmessage'];?></td>
  </tr>
   <tr>
    <th>Instructions for Delivery</th>
    <td><?php  echo $row['addmessage'];?></td>
  </tr>
    <tr>
    <th>Receipts</th>
    <td><img src="receiptimages/<?php echo $row['image'];?>" width="360" height="640"></td>
  </tr>
  <tr>
...
if($row['OrderFinalStatus']=="Gift being Prepared")
{
  echo "Gift being Prepared";
}
if($row['OrderFinalStatus']=="Gift Pickup")
{
  echo "Gift Pickup";
}
if($row['OrderFinalStatus']=="Gift Delivered")
{
  echo "Gift Delivered";
}
if($row['OrderFinalStatus']=="")
{
  echo "Wait for company approval";
}
...
<?php
  ...
  if($orserstatus=="Order Confirmed" || $orserstatus=="Gift being Prepared" || $orserstatus=="Gift Pickup" || $orserstatus=="" ){ ?>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="4" >Gift Tracking History</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Remark</th>

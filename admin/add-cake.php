...
else
{
    ...
    if ($query) {
   echo '<script>alert("Gift has been added")</script>';
...
<head>
    <title>SSK Surprise Delivery System|| Add Gift</title>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit" enctype="multipart/form-data">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Gift Category:</label>
      ...
      $query=mysqli_query($con,"select * from  tblcategory");
              ...
              <option value="<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Gift Theme:</label>

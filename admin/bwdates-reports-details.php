...
<head>
    ...
    <title>SSK Surprise Delivery||Between Dates Report Details</title>
...
$cnt=$cnt+1;
                         ...
                         <?php if($rtype=="Gift being Prepared"){?>
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Gift being Prepared' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of Order Pickup</h4>                         
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Gift Pickup' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of delivered Orders</h4>                         
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Gift Delivered' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

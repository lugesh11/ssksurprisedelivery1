...
<head>
    ...
    <title>SSK Surprise Delivery|| Between Dates Report</title>
...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="">Not Confirmed Order
                  ...
                  <input type="radio" name="requesttype" value="Order Confirmed">Confirmed Order
                    <input type="radio" name="requesttype" value="Gift being Prepared">Gift Being Prepared Order
                      <input type="radio" name="requesttype" value="Gift Pickup">Gift Pickup Order
                      <input type="radio" name="requesttype" value="Gift Delivered">Gift Delivered order
                                        </div>
                                    </div>

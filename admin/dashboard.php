...
<head>
    <title>SSK Suprise Delivery System || Dashboard</title>
...
?>
<a class="text-muted text-uppercase m-b-20" href="cakebeingprepared.php" style="font-size: 20px"><strong>Gift being Prepared</strong></a>
                               
                              
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $beigpre;?></h1>
                                <small>Gift being Prepared</small>
                            </div>
                        </div>
            </div>
...
?>
<a class="text-muted text-uppercase m-b-20" href="cake-pickup.php" style="font-size: 20px"><strong> Gift Pickup</strong></a>
                                
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $foodpickup;?></h1>
                                
                                <small> Gift Pickup</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
?>
<a class="text-muted text-uppercase m-b-20" href="Cake-delivered.php" style="font-size: 20px"><strong>Total Gift Deliver</strong></a>

                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $fooddel;?></h1>
                                <small>Total Gift Deliver</small>
                            </div>
                        </div>
                    </div>

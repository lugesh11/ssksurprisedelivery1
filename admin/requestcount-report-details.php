...
<head>
    ...
    <title>SSK Surprise Delivery</title>
...
$ret=mysqli_query($con,"select month(OrderTime) as lmonth,year(OrderTime) as lyear,
    ...
    count(if(OrderFinalStatus='Gift being Prepared',0,null)) as fdbgpr,
    count(if(OrderFinalStatus='Gift Pickup',0,null)) as foodpickup,
    count(if(OrderFinalStatus='Gift Delivered',0,null)) as fooddel,

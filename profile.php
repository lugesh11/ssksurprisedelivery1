...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tbluser set FirstName='$fname', LastName='$lname', Email='$email', MobileNumber='$pnum' where ID='$sid'");
...
<head>
        <title>SSK Surprise Delivery|| Profile</title>
...
?>  
              ...
              <div class="form-group col-md-12">
                <input type="text" class="form-control" id="pnum" name="pnum" value="<?php  echo $row['MobileNumber'];?>" readonly="true">
              </div>
